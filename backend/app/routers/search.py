...
from app.models.search import SearchRequest, SearchResponse, StoresResponse, Store
...
async def search_products(
    ...
    """
    Suche nach Produkten in der Datenbank
...
async def get_stores(
    ...
    """
    Gibt eine Liste aller verfügbaren Supermärkte aus der Datenbank zurück
    """
    try:
        logger.info("Getting stores from database")
        ...
        logger.info(f"Found {len(app_compatible_stores)} enabled stores")
